...
section .text
	global _ft_write
	extern ___error ; Declaración de la función de error, asumiendo que existe en otro archivo
...
error:
	...
	call ___error ; llama a la función de error para imprimir el mensaje
	add rsp, 8 ; limpia la pila después de la llamada a error
	mov dword [rax], r8d ; coloca el valor de retorno (-1) en la pila para devolverlo
